...
//Função //Nome da função  //(parametros)
function imprimeTexto(texto) {
    console.log(texto)
}

// 2) Executa a função
// Pode ser chamada diversas vezes
imprimeTexto("oi");
imprimeTexto("outro texto");
*/

//Funções servem para executarmos trechos de códigos em momentos que desejarmos
// Existem 3 formas de escrever funções

/*
function soma() {
    const resultado = 2 + 2;
    return resultado; // Retorna o valor da função quando chamada
    // return 2+2;
}
console.log(soma()) //Se não retornarmos nada da função, o resultado será undefined
*/
...
imprimeTexto(soma());
// Neste caso, o JS resolve a função soma e o resultado é o parametro para imprimeTexto()

// O JS oferece algumas funções prontas, exemplos: 
/*
